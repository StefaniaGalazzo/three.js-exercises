...
// node_modules/three-tween/index.js
var require_three_tween = __commonJS({
  "node_modules/three-tween/index.js"(exports, module) {
    ...
    TWEEN.Tween = function(a) {
      var c = {}, b = {}, d = 1e3, e = 0, f = null, h = TWEEN.Easing.Linear.None, r = TWEEN.Interpolation.Linear, k = [], l = null, m = false, n = null, p = null;
      this.to = function(a2, c2) {
        null !== c2 && (d = c2);
        b = a2;
        return this;
      };
      this.start = function(d2) {
        TWEEN.add(this);
        m = false;
        f = void 0 !== d2 ? d2 : Date.now();
        f += e;
        for (var g in b)
          if (null !== a[g]) {
      ...
      this.delay = function(a2) {
        e = a2;
        return this;
      };
      this.easing = function(a2) {
        h = a2;
        return this;
      };
      this.interpolation = function(a2) {
        r = a2;
        return this;
      };
      this.chain = function() {
      ...
      this.onStart = function(a2) {
        l = a2;
        return this;
      };
      this.onUpdate = function(a2) {
        n = a2;
        return this;
      };
      this.onComplete = function(a2) {
        p = a2;
        return this;
      };
      this.update = function(e2) {
        if (e2 < f)
          return true;
        false === m && (null !== l && l.call(a), m = true);
        var g = (e2 - f) / d, g = 1 < g ? 1 : g, i = h(g), j;
        for (j in c) {
          var s = c[j], q = b[j];
...
export default require_three_tween();
//# sourceMappingURL=three-tween.js.map
